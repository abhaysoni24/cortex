  ...
  return (
    <Dialog.Root open={open} onOpenChange={onOpenChange}>
      <Dialog.Portal>
        ...
        <Dialog.Content
          className={cn(
            'fixed left-1/2 top-[20%] z-50 w-full max-w-lg -translate-x-1/2 overflow-hidden rounded-lg border border-border-default bg-bg-overlay shadow-2xl',
          ...
          <Command className="flex flex-col" loop>
            ...
            <div className="flex items-center gap-2 border-b border-border-subtle px-3">
              ...
              <Command.Input
                ...
                className="flex-1 bg-transparent py-3 text-sm text-text-primary outline-none placeholder:text-text-tertiary"
                autoFocus
              />
            </div>
...
function CommandItem({
  ...
  return (
    <Command.Item
      className="flex cursor-pointer items-center gap-2.5 rounded-md px-2 py-2 text-sm text-text-secondary data-[selected=true]:bg-bg-elevated data-[selected=true]:text-text-primary"
      value={label}
    >
